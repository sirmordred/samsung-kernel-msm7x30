...
#define DFT_BRIGHTNESS_LEVEL    141
#define LOW_BRIGHTNESS_LEVEL    30
#define MAX_BACKLIGHT_VALUE2	25
#define MAX_BACKLIGHT_VALUE	25
#define LOW_BACKLIGHT_VALUE	6
#define DIM_BACKLIGHT_VALUE	3
...
static struct samsung_spi_data panel_on_sequence[] = {
    ...
    { .addr = 0xF3, .len = 12, .data = { 0x00, 0x10, 0x25, 0x10, 0x2D, 0x2D, 0x24, 0x2D, 0x10, 0x10, 0x0A, 0x37 }, .delay = 0 },
    ...
    { .addr = 0xF7, .len = 17, .data = { 0x04, 0x6E, 0x00, 0x12, 0x03, 0x0D, 0x0A, 0x16, 0x05, 0x04, 0x0E, 0x04, 0x04, 0x00, 0x96, 0x01, 0x18 }, .delay = 0 },
    { .addr = 0xF8, .len = 17, .data = { 0x04, 0x6E, 0x00, 0x00, 0x03, 0x0D, 0x0A, 0x16, 0x05, 0x04, 0x0E, 0x04, 0x04, 0x00, 0x96, 0x01, 0x18 }, .delay = 0 },
    { .addr = 0xF9, .len = 22, .data = { 0x01, 0x02, 0x05, 0x04, 0x0A, 0x0B, 0x00, 0x06, 0x11, 0x10, 0x0F, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0xCF, 0xFF, 0xF0 }, .delay = 0 },
    { .addr = 0xFA, .len = 45, .data = { 0x30, 0x3F, 0x38, 0x29, 0x38, 0x3D, 0x3C, 0x2D, 0x27, 0x3E, 0x2E, 0x31, 0x37, 0x32, 0x30, 0x00, 0x3F, 0x38, 0x29, 0x38, 0x3C, 0x39, 0x2B, 0x24, 0x37, 0x21, 0x1C, 0x1D, 0x0F, 0x04, 0x00, 0x3F, 0x3A, 0x2C, 0x3B, 0x3B, 0x3B, 0x2C, 0x25, 0x36, 0x1E, 0x17, 0x18, 0x0B, 0x03 }, .delay = 0 },
    { .addr = 0xFB, .len = 45, .data = { 0x00, 0x0F, 0x0F, 0x0D, 0x28, 0x2E, 0x31, 0x21, 0x19, 0x32, 0x23, 0x22, 0x27, 0x16, 0x07, 0x00, 0x3F, 0x3B, 0x30, 0x42, 0x43, 0x3E, 0x28, 0x1C, 0x34, 0x26, 0x23, 0x27, 0x16, 0x07, 0x00, 0x3F, 0x3C, 0x34, 0x47, 0x48, 0x41, 0x29, 0x1B, 0x33, 0x24, 0x24, 0x24, 0x13, 0x05}, .delay = 0 },
...
static struct samsung_spi_data panel_on_sequence_smd[] = {
	...
	{ .addr = 0xC8, .len = 38, .data = {0x00, 0x7A, 0x09, 0x11, 0x1F, 0x27, 0x27, 0x2E, 0x2E, 0x38, 0x45, 0x46, 0x48, 0x46, 0x4F, 0x5A, 0x5A, 0x5D, 0x3C, 0x00, 0x7A, 0x09, 0x11, 0x1F, 0x27, 0x27, 0x2E, 0x2E, 0x38, 0x45, 0x46, 0x48, 0x46, 0x4F, 0x5A, 0x5A, 0x5D, 0x3C }, .delay = 0 },
	{ .addr = 0xC9, .len = 38, .data = {0x00, 0x41, 0x13, 0x20, 0x34, 0x41, 0x44, 0x46, 0x4A, 0x54, 0x5C, 0x5D, 0x5D, 0x5A, 0x5E, 0x65, 0x64, 0x65, 0x3E, 0x00, 0x41, 0x13, 0x20, 0x34, 0x41, 0x44, 0x46, 0x4A, 0x54, 0x5C, 0x5D, 0x5D, 0x5A, 0x5E, 0x65, 0x64, 0x65, 0x3E }, .delay = 0 },
	{ .addr = 0xCA, .len = 38, .data = {0x00, 0x28, 0x15, 0x25, 0x3B, 0x4A, 0x4D, 0x50, 0x54, 0x5E, 0x66, 0x66, 0x66, 0x62, 0x67, 0x6B, 0x69, 0x68, 0x40, 0x00, 0x28, 0x15, 0x25, 0x3B, 0x4A, 0x4D, 0x50, 0x54, 0x5E, 0x66, 0x66, 0x66, 0x62, 0x67, 0x6B, 0x69, 0x68, 0x40 }, .delay = 0 },
